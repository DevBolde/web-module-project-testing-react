...
test("renders default image when image is not defined", () => { 
    ...
    const image = screen.queryByAltText("https://static.tvmaze.com/uploads/images/medium_landscape/342/855786.jpg");
...
// - [ ] Modify the test data to display a specific summary statement. Complete a test that shows that the summary value passed in to the Episode component displays as expected. **Use at least 3 different types of expect statements to test the the existence of the summary value.**
